...
int main()
{
    ...
    while(1)
    {
        ...
        case 6:
            ...
            textcolor(LIGHTRED);
            printf("\nPress any key to go back to the main scren");
            getch();
            clrscr();
            break;
        case 7:
            ...
            if(ticket_no!=0){
                ...
                else if(result==1)
                {
                    ...
                    {
                        textcolor(LIGHTRED);
                        printf("Sorry error while cancelling");
                    }
                    textcolor(WHITE);
                    printf("\n\nPress any key to go back to the main screen!");
        ...
        case 8:
          ...
          ptrain_no=accept_train_no();
            if(ptrain_no!=NULL){
                ...
                {
                    textcolor(LIGHTRED);
                    printf("Sorry No Train Found against Train no %s",ptrain_no);

                }
                else if(result==1)
                {
                    textcolor(LIGHTGREEN);
                    printf("Train %s Successfully cancelled",ptrain_no);
